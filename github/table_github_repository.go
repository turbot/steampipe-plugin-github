...
func sharedRepositoryColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{Name: "code_of_conduct", Type: proto.ColumnType_JSON, Hydrate: repoHydrateCodeOfConduct, Transform: transform.FromValue().NullIfZero().NullIfEmptySlice(), Description: "The code of conduct for this repository."},
		...
		{Name: "default_branch_ref", Type: proto.ColumnType_JSON, Hydrate: repoHydrateDefaultBranchRef, Transform: transform.FromValue().NullIfZero().NullIfEmptySlice(), Description: "Default ref information."},
		...
		{Name: "license_info", Type: proto.ColumnType_JSON, Hydrate: repoHydrateLicenseInfo, Transform: transform.FromValue().NullIfZero().NullIfEmptySlice(), Description: "The license associated with the repository."},
		...
		{Name: "primary_language", Type: proto.ColumnType_JSON, Hydrate: repoHydratePrimaryLanguage, Transform: transform.FromValue().NullIfZero().NullIfEmptySlice(), Description: "The primary language of the repository's code."},
