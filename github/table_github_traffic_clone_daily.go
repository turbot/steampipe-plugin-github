...
func tableGitHubTrafficCloneDaily() *plugin.Table {
	return &plugin.Table{
		...
		Description: "Daily traffic clone stats over the last 14 days for the given repository.",
		...
		Columns: commonColumns([]*plugin.Column{
			...
			{Name: "uniques", Type: proto.ColumnType_INT, Description: "Unique clone count for the day."},
		}),
	}
}
