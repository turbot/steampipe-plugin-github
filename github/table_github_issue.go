...
func sharedIssueColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{Name: "labels", Type: proto.ColumnType_JSON, Description: "A map of label names associated with this issue, in Steampipe standard format.", Transform: transform.From(getIssueLabels)},
