...
func gitHubTeamRepositoryColumns() []*plugin.Column {
	...
	// TODO: Move to a shared function in `github_repository.go` when refactoring that table.
	repoColumns := []*plugin.Column{
		...
		{Name: "funding_links", Type: proto.ColumnType_JSON, Transform: transform.FromField("FundingLinks", "Node.FundingLinks"), Description: "The funding links for this repository."},
		...
		{Name: "issue_templates", Type: proto.ColumnType_JSON, Transform: transform.FromField("IssueTemplates", "Node.IssueTemplates"), Description: "A list of issue templates associated to the repository."},
		...
		{Name: "primary_language", Type: proto.ColumnType_JSON, Transform: transform.FromField("PrimaryLanguage", "Node.PrimaryLanguage"), Description: "The primary language of the repository's code."},
		...
		{Name: "possible_commit_emails", Type: proto.ColumnType_JSON, Transform: transform.FromField("PossibleCommitEmails", "Node.PossibleCommitEmails"), Description: "A list of emails you can commit to this repository with."},
	...
	return append(teamColumns, repoColumns...)
}
