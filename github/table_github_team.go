...
func gitHubTeamColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{Name: "discussions_total_count", Type: proto.ColumnType_INT, Description: "DEPRECATED: Count of team discussions.", Transform: transform.FromValue(), Hydrate: teamHydrateDiscussionsTotalCount},
		...
		{Name: "discussions_url", Type: proto.ColumnType_STRING, Description: "DEPRECATED: URL for team discussions.", Transform: transform.FromValue(), Hydrate: teamHydrateDiscussionsUrl},
